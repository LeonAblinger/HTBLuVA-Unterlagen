...
#ifdef _DEBUG
	#define LOG1(message) printf("file %s | Line: %4u | msg: %s",__FILE__,__LINE__,message)
	#define LOG2(message) printf("FILE: %s | FUNC: %s | LINE: %4u | MSG: %s",__FILE__,__func__,__LINE__,message)
#endif
